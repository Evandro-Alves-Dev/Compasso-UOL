...
````
Para acessar o banco H2 utilizar a URL http://localhost:9999/h2 no navegador, colocar no campo *JDBC URL - jdbc:h2:mem:uol* (para banco em memória, que é apagado toda vez que a aplicação é derrubada) ou *jdbc:h2:file:~/compasso/uol*
(para banco que persiste os dados mesmo com a aplicação derrubada. Descomentar a linha 10 do application.properties). No campo User Name e Password colocar **uol**.
...
Cobertura da clase service, pois é a principal e onde estão as regras de negocio do micorserviço.
